...
export default function ComingSoon() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <div className="w-20 h-20 bg-neutral-800  flex items-center justify-center mb-6">
      ...
      <Link href="/" className="px-6 py-3 bg-red-600 text-white font-medium  hover:bg-red-500 transition-colors">
        Return to Discover
      </Link>
    </div>
  );
