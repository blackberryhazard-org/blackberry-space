...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] py-12">
      <div className="w-full max-w-md bg-neutral-900 border border-neutral-800  p-8 flex flex-col items-center text-center">
        <div className="w-16 h-16 bg-primary flex items-center justify-center shadow-[0_0_20px_rgba(74,222,128,0.2)] mb-6">
          <span className="text-[#121212] font-black text-2xl tracking-tighter">&lt;/&gt;</span>
        </div>

        <h1 className="text-3xl font-bold tracking-tight text-white mb-2 uppercase tracking-[0.05em]">
          Welcome Back
        </h1>
        <p className="text-neutral-400 mb-8 leading-relaxed">
          Sign in to access your snippets, save favorites, and share code with the Blackberry Space community.
        </p>
        ...
        <div className="w-full flex flex-col gap-4">
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 bg-white text-black hover:bg-neutral-200 transition-colors font-bold py-3.5 px-4  ${(isLoadingGithub || isLoadingDiscord) ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
          ...
          <button
            ...
            disabled={isLoadingGithub || isLoadingDiscord}
            className={`w-full flex items-center justify-center gap-3 bg-[#5865F2] text-white hover:bg-[#4752C4] transition-colors font-bold py-3.5 px-4  ${(isLoadingGithub || isLoadingDiscord) ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
            {/* Discord Icon SVG */}
